...
class Helpers {
    ...
    public static function getMonthName($number) {
        ...
        if($lang == 'ru'){
            $monthAr = array(
                1 => array('Январь', 'Январь'),
                2 => array('Февраль', 'Февраль'),
                3 => array('Март', 'Март'),
                4 => array('Апрель', 'Апрель'),
                5 => array('Май', 'Май'),
                6 => array('Июнь', 'Июнь'),
                7 => array('Июль', 'Июль'),
                8 => array('Август', 'Август'),
                9 => array('Сентябрь', 'Сентябрь'),
                10=> array('Октябрь', 'Октябрь'),
                11=> array('Ноябрь', 'Ноябрь'),
                12=> array('Декабрь', 'Декабрь')
            );
        }
        else if($lang == 'kz'){
            $monthAr = array(
