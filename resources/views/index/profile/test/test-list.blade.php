        ...
        <article class="right-content">
            <div class="right-content-inner">
                ...
                <div class="olympiad-tab">
                    <button class="btn-plain olympiad-tablink " onclick="showTestList(this,1)">Незавершенные</button>
                    <button class="btn-plain olympiad-tablink active" onclick="showTestList(this,0)">Пройденные</button>
                </div>
